...
export default function EditEmployee({
  ...
  const updateAccountMutation = useUpdateAccountMutation(id as number)
  ...
  const onSubmit = async (body: UpdateEmployeeAccountBodyType) => {
    ...
    try {
      ...
      const res = await updateAccountMutation.mutateAsync(body)
